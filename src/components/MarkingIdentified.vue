<template>
    <div class="fcb-marking-assistance">
        <div class="fcb-wrap-body">
            ...
            <p>
                FedEx Cross Border has received your products and uploaded any images of the markings found. Please review the images below and certify the Country of Origin for those products. If products are not certified within 2 business days, they will be canceled from the associated order.
            </p>
            <div class="">
